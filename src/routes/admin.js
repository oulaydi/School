...
//admin add room get form add room view
router.get("/admin/add-room", authMiddleware, directorController.director_Add_Room);

//admin add room use post in db
